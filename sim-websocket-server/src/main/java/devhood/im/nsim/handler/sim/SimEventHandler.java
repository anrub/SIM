...
public class SimEventHandler implements ISimEventHandler {
	...
	private Logger log = Logger.getLogger(SimEventHandler.class);
	...
	public SimEventHandler(Broadcaster broadcaster) {
		...
		map.put(Events.SEND_MESSAGE, new SendMessageHandler(broadcaster));
	...
	public void handle(Events e, Object payload) {
		log.info("Event von SIM core received: " + e + ", Inhalt: " + payload);
